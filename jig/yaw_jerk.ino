...
void loop()
{
  ...
  Joint1.write(Joint1Offset); // Move Joint 1 to 90 degrees
  delay(500); // Wait for 1 second to allow it to move

  Joint1.write(30+Joint1Offset); // Move Joint 1 to 90 degrees
  delay(500); // Wait for 1 second to allow it to move

  Joint1.write(60+Joint1Offset); // Move Joint 1 to 90 degrees
  delay(500); // Wait for 1 second to allow it to move

  Joint1.write(90 + Joint1Offset); // Return to the starting position
